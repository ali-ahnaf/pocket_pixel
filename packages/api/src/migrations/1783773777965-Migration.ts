...
export class Migration1783773777965 implements MigrationInterface {
    name = 'Migration1783773777965'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_debts"("id", "userId", "title", "amount", "type", "createdAt", "updatedAt", "deletedAt", "notes", "completed") SELECT "id", "userId", "title", "amount", "type", "createdAt", "updatedAt", "deletedAt", "notes", "completed" FROM "debts"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "debts" ("id" varchar PRIMARY KEY NOT NULL, "userId" varchar NOT NULL, "title" varchar(200) NOT NULL, "amount" decimal(10,2) NOT NULL DEFAULT (0), "type" varchar NOT NULL DEFAULT ('expense'), "createdAt" datetime DEFAULT (datetime('now')), "updatedAt" datetime DEFAULT (datetime('now')), "deletedAt" datetime, "notes" text, "completed" boolean NOT NULL DEFAULT (0), CONSTRAINT "FK_834960a509c776eb841644a9bac" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "debts"("id", "userId", "title", "amount", "type", "createdAt", "updatedAt", "deletedAt", "notes", "completed") SELECT "id", "userId", "title", "amount", "type", "createdAt", "updatedAt", "deletedAt", "notes", "completed" FROM "temporary_debts"`);
