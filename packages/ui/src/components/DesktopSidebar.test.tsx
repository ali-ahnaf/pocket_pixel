...
describe('DesktopSidebar', () => {
  ...
  it('marks the current route as active', () => {
    ...
    expect(screen.getByRole('link', { name: /home/i }).hasAttribute('aria-current')).toBe(false);
  });

  it('displays profile information from props', () => {
    render(<DesktopSidebar name="Arshad" email="arshad@example.com" avatar="/avatar.png" />);
  ...
  it('loads profile information from localStorage when props are absent', async () => {
    ...
    expect(screen.getByAltText('Player Avatar').getAttribute('src')).toBe('/stored-avatar.png');
  });
