...
interface DiscardDebtModalProps {
  isOpen: boolean;
  onClose: () => void;
  debtTitle: string;
  onDiscard: () => void;
...
export function DiscardDebtModal({ isOpen, onClose, debtTitle, onDiscard }: DiscardDebtModalProps) {
        ...
        <main className="px-6 py-6 pt-0 space-y-6 mt-6">
          <div className="space-y-4">
            <p className="font-body-md text-on-surface-variant">
              Are you sure you want to discard the due <strong className="text-on-surface">"{debtTitle}"</strong>? This template will be removed and can no longer be applied.
            </p>
          </div>

          <div className="pt-2 flex gap-4">
            <Button variant="ghost" className="w-full py-3 flex items-center justify-center" onClick={onClose}>
            ...
            >
              ...
              <span className="font-headline-sm uppercase tracking-wider">Discard</span>
            </Button>
          </div>
        </main>
