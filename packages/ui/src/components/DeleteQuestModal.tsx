...
export function DeleteQuestModal({ isOpen, onClose, questName, onDelete }: DeleteQuestModalProps) {
        ...
        <main className="px-6 py-6 pt-0 space-y-6 mt-6">
          <div className="space-y-4">
            <p className="font-body-md text-on-surface-variant">
              Are you sure you want to delete the recurring quest <strong className="text-on-surface">"{questName}"</strong>? This action cannot be undone.
            </p>
          </div>
